...
class Main(IOvservable):
    ...
    def __init__(self):
        ...
        super(Main, self).__init__(self.results_path)
    ...
    def start_slips_parser(self):
        ...
        SlipsParser(self.output_dir, slips_db=slips_db).parse()
    ...
    def start_suricata_parser(self):
        ...
        SuricataParser(self.output_dir, eve_file=eve_file).parse()
    ...
    def main(self):
        ...
        if self.args.confusion_matrix_db:
            ...
            for comparison_method in supported_comparison_methods:
                ...
                print('-' * 30)
                self.log("Comparison type: ", comparer.name)
                print()
